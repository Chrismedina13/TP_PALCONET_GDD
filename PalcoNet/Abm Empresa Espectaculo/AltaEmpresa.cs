...
namespace PalcoNet.Abm_Empresa_Espectaculo
{
    public partial class AltaEmpresa : Form
    {
        ...
        private void buttonAgregar_Click(object sender, EventArgs e)
        {
            ...
            if (ConsultasSQL.existeCuit(textBoxCuit.Text))
            {
            ...
            ConsultasSQL.AgregarEmpresa(razonSocial, cuit, ciudad,mail,telefono,usuario,hoy);
            ConsultasSQL.AgregarDomicilio(calle, nroCalle, piso, dto, localidad, codPostal, razonSocial, cuit);
